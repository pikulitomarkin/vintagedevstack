export function initVintage() {
  ...
  const COMMANDS = {
    ...
    exit: () => 'EXIT',
    matrix: () => 'MATRIX',
    metal: () => { window.dispatchEvent(new CustomEvent('crt-action', { detail: 'metal' })); return ["CH 2: LOADING METAL SLUG..."]; },
    metal3: () => { window.dispatchEvent(new CustomEvent('crt-action', { detail: 'metal3' })); return ["CH 3: LOADING METAL SLUG 3..."]; },
    metalslug: () => { window.dispatchEvent(new CustomEvent('crt-action', { detail: 'metalslug' })); return ["CH 2: LOADING METAL SLUG..."]; },
    metalslug3: () => { window.dispatchEvent(new CustomEvent('crt-action', { detail: 'metalslug3' })); return ["CH 3: LOADING METAL SLUG 3..."]; },
    slug: () => { window.dispatchEvent(new CustomEvent('crt-action', { detail: 'slug' })); return ["CH 2: LOADING METAL SLUG..."]; },

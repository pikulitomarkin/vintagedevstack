export function initVintage() {
  ...
  const COMMANDS = {
    help: () => [
      ...
      "  metalslug     — play metal slug (crt ch 2)",
      "  slug / mario  — alias for metalslug",
    ...
    mario: () => { window.dispatchEvent(new CustomEvent('crt-action', { detail: 'mario' })); return ["CH 2: LOADING METAL SLUG..."]; },

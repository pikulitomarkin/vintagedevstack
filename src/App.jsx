      ...
      <div className="hero-grid">
        <div className="hero-left">
          ...
          <div className="cta-row">
            <a className="btn primary" href="https://wa.me/5511000000000" target="_blank" rel="noopener">
        ...
        <div className="crt-wrap" aria-hidden="true">
          <div className="crt">
            <div className="crt-top">
              <span className="label">PADILHA-CRT MODEL 87</span>
        ...
        <div>
          <div className="card">
            ...
            <div className="channels">
              <a className="channel" href="https://wa.me/5511000000000" target="_blank" rel="noopener">
                <span className="ic">
